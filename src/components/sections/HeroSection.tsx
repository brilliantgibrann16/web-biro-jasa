...
function DesktopDossier() {
  return (
    <div
      ...
      aria-hidden="true"
    >
      <div className="absolute bottom-6 right-0 top-16 w-[72%] rotate-2 rounded-sm border border-white/10 bg-white/[0.025]" />
      ...
      <p className="absolute bottom-2 right-14 text-[0.62rem] font-black uppercase tracking-[0.22em] text-white/70">
...
function MobileCaseFile() {
  return (
    <div className="relative h-[198px] w-full" aria-hidden="true">
      <div className="absolute inset-x-5 bottom-0 top-5 rotate-2 rounded-sm border border-white/12 bg-white/[0.03]" />
...
export default function HeroSection() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_82%_22%,rgba(215,154,85,0.15),transparent_30%),linear-gradient(140deg,#050b13_0%,#07111f_48%,#101b2e_100%)]" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 pb-16 pt-28 sm:px-8 lg:hidden">
        <p className="text-[0.64rem] font-black uppercase tracking-[0.2em] text-primary-light">
          Biro jasa administrasi
        </p>
        <h1 className="mt-4 font-display text-[3.15rem] font-semibold leading-[0.93] text-white">
          Biro Jasa
          <span className="block text-primary-light">Tiga Saudara</span>
        </h1>
        <p className="mt-5 max-w-md text-lg font-semibold leading-7 text-white/88">
        ...
        <p className="mt-5 border-l border-primary-light/55 pl-4 text-sm font-semibold leading-6 text-neutral-300">
          {COMPANY.tagline}
        </p>
        ...
        <div className="mt-6 grid grid-cols-[minmax(0,1fr)_auto] items-center gap-4">
          <a
            ...
            className="inline-flex min-h-12 items-center justify-center gap-2 rounded-sm bg-primary-dark px-5 py-3.5 text-sm font-extrabold text-white transition-colors hover:bg-navy-light"
          >
          ...
          <Link
            href="/layanan"
            className="inline-flex min-h-12 items-center gap-2 border-b border-primary-light/70 text-sm font-extrabold text-white"
          >
            Layanan
        ...
        <div className="mt-7 flex flex-wrap gap-x-5 gap-y-2 border-t border-white/12 pt-5">
          {proofPoints.map((item) => (
            <p key={item} className="text-xs font-bold text-white/70">
              {item}
            </p>
          ))}
        </div>
      ...
      <div className="relative z-10 mx-auto hidden min-h-[92vh] w-full max-w-7xl grid-cols-[minmax(0,0.94fr)_minmax(0,1.06fr)] items-center gap-10 px-8 pb-24 pt-36 lg:grid">
        <div className="max-w-3xl">
          <p className="text-[0.68rem] font-black uppercase tracking-[0.22em] text-primary-light">
            Biro jasa administrasi
          </p>
          <h1 className="mt-5 font-display text-[6.7rem] font-semibold leading-[0.94] text-white">
            Biro Jasa
            <span className="block text-primary-light">Tiga Saudara</span>
          </h1>

          <p className="mt-7 max-w-2xl text-2xl font-medium leading-10 text-white">
          ...
          <div className="mt-10 flex gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center justify-center gap-3 rounded-sm bg-primary-dark px-7 py-4 text-base font-extrabold text-white transition-colors hover:bg-navy-light"
            >
              <MessageCircle className="h-5 w-5" aria-hidden="true" />
              Bicarakan Berkas
            </a>
            <Link
              href="/layanan"
              className="group inline-flex items-center justify-center gap-3 rounded-sm border border-white/18 px-7 py-4 text-base font-extrabold text-white transition-colors hover:border-primary-light/60"
            >
              Lihat layanan
              <ArrowRight className="h-4 w-4" aria-hidden="true" />
            </Link>
          ...
          <div className="mt-10 grid max-w-2xl grid-cols-3 gap-3 border-t border-white/12 pt-6">
            {proofPoints.map((item) => (
              <div key={item} className="flex items-center gap-3 text-sm font-bold text-white/74">
                <span className="h-px w-6 bg-primary-light/70" />
                {item}
              </div>
            ))}
          </div>
