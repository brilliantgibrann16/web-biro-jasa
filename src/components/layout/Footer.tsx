      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
        <div className="grid gap-12 border-y border-neutral-300/60 py-16 dark:border-white/[0.08] md:py-20 lg:grid-cols-[minmax(0,1.18fr)_minmax(0,0.72fr)_minmax(0,0.72fr)] lg:gap-16">
          <div>
            ...
            <h3 className="mt-6 max-w-2xl text-3xl font-semibold leading-tight text-accent dark:text-white sm:text-5xl">
          ...
          <div>
            <h4 className="text-[0.72rem] font-black uppercase tracking-[0.18em] text-neutral-600 dark:text-neutral-400">
              Navigasi
            </h4>
          ...
          <div>
            ...
            <div className="mt-6 space-y-5">
              <div className="flex items-start gap-3">
                <Phone className="mt-1 h-4 w-4 text-primary-dark dark:text-primary-light" />
                <p className="text-sm font-semibold text-neutral-700 dark:text-neutral-300">
                  {COMPANY.phone}
                </p>
              </div>
              <div className="flex items-start gap-3">
                <Clock3 className="mt-1 h-4 w-4 text-primary-dark dark:text-primary-light" />
